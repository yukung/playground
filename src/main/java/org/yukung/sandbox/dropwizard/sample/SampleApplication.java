...
import org.yukung.sandbox.dropwizard.sample.resources.EmployeeResource;
...
public class SampleApplication extends Application<SampleConfiguration> {
	...
	private final HibernateBundle<SampleConfiguration> hibernateBundle =
			new HibernateBundle<SampleConfiguration>(Person.class) {
				@Override
	...
	public void run(SampleConfiguration configuration, Environment environment) throws Exception {
		...
		environment.jersey().register(
				new BasicAuthProvider<>(new SampleAuthenticator(), "SUPER SECRET STUFF"));
